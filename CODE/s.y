...
for_stmt:
    FOR OPEN_PAREN init_for corp_for OPEN_BRACE instruction_list CLOSE_BRACE {
        ...
        strcpy(tab_quad[expFor].op1,temp);
    }
    ;
...
while_stmt:
   debut_while  corp_while instruction_list CLOSE_BRACE {
    ...
    strcpy(tab_quad[addrDebutWhile].op1,adresse);
    };
...
expression:
    expression OR expression   {  // ppas sur 
